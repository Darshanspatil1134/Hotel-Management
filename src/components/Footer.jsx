      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Crest the Grand Hotel of Dreams, Nashik, Maharashtra.
        ...
        <div>
          ...
          <ul className="text-sm space-y-2">
            ...
            <li>📧 crestthegrandhotel@gmail.com</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Crest The Grand Hotel of Dreams, near K.K. Wagh College, Nashik, Maharashtra  - 422009, India.
          </p>
        </div>
